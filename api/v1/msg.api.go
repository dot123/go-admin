...
// RegisterRoute 注册路由
func (a *MsgApi) RegisterRoute(r *gin.RouterGroup) {
	r.GET("msg/notice", a.GetPage)
	r.POST("msg/notice", a.Create)
	r.PUT("msg/notice", a.Update)
	r.DELETE("msg/notice/:id", a.Delete)
}
